...
$router->get('/', [ProductController::class, 'getDashboard']);
$router->get('/products/create_product', [ProductController::class, 'getCreate']);
$router->get('/products/detail', [ProductController::class, 'getDetail']);
